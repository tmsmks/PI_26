...
DATA_SOURCES = [
    ...
    {"name": "Open-Meteo Forecast",
     "icon": "🔮", "type": "Météo prévision", "role": "model_pipeline",
     "desc": "Prévisions 7 j (onglet Prévisions J+7 + temps réel)"},
    {"name": "Electricity Maps API",
     "icon": "⚡", "type": "Réseau local", "role": "context_app",
     "desc": "Charge réseau zone, carbone, mix — panneau temps réel, pas dans le modèle"},
    {"name": "EskomSePush",
